...
STYLE_LIST = [
    ...
    {"name":"Chinese",
    "prompt":"chinese still {prompt}. only use achromatic, classic paint painting, only use black and white, painted by brush, traditional chinese style."}
]
...
def process(
    ...
    with open("nonope.json", "r", encoding="utf-8") as f:
        prompt = json.load(f)
